...
<div class="modal-body">
    <h3 class="m-t-none m-b">Postuler a ce job</h3>
    <p>Améloirer votre experience sur LifeWork</p>

    @Using (Html.BeginForm("PostulerA1Job", "PostulerJob", FormMethod.Post))
        ...
        @<div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    <input type="submit" value="@Resource.Btn_Ajouter" class="btn btn-default" id="approve-btn" />
                </div>
            </div>
        </div>
    End Using
