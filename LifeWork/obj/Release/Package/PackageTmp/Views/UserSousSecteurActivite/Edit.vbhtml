@ModelType UserSousSecteurActiviteViewModel
@Imports LifeWork.My.Resources
@Code
    ViewData("Title") = Resource.Edit_UserSousSecteurActivite
End Code

<h2>@Resource.Edit_UserSousSecteurActivite</h2>
...
@Using (Html.BeginForm())
    ...
    @Html.HiddenFor(Function(model) model.SousSecteurActiviteId)
