...
@Code
    ViewData("Title") = Resource.Details_Certification
End Code

<h2>@Resource.Details_Certification</h2>
<hr />
...
<p>
    @Html.ActionLink(Resource.Edit_Certification, "Edit", New With { .id = Model.Id }) |
