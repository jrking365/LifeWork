...
Namespace Migrations
    Public Partial Class LifeWorkDB
        ...
        Public Overrides Sub Up()
            CreateTable(
                ...
                .ForeignKey("dbo.Cv", Function(t) t.CvId) _
            ...
            CreateTable(
                ...
                Function(c) New With
                    {
                        .Id = c.Long(nullable := False, identity := True),
                        .UserPublierId = c.String(maxLength := 128),
                        .UserAttribuerId = c.String(maxLength := 128),
                        .TypeJobId = c.Long(),
                        .SousSecteurActiviteId = c.Long(),
                        .StatutId = c.Long(),
                        .Titre = c.String(nullable := False, maxLength := 500),
                        .Duree = c.String(),
                        .Code = c.String(),
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.SousSecteurActivite", Function(t) t.SousSecteurActiviteId) _
                .ForeignKey("dbo.Statut", Function(t) t.StatutId) _
                .ForeignKey("dbo.TypeJob", Function(t) t.TypeJobId) _
                .ForeignKey("dbo.AspNetUsers", Function(t) t.UserAttribuerId) _
                .ForeignKey("dbo.AspNetUsers", Function(t) t.UserPublierId) _
                .Index(Function(t) t.UserPublierId) _
                .Index(Function(t) t.UserAttribuerId) _
                .Index(Function(t) t.TypeJobId) _
                .Index(Function(t) t.SousSecteurActiviteId) _
                .Index(Function(t) t.StatutId)
            ...
            CreateTable(
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.SecteurActivite", Function(t) t.SecteurActiviteId) _
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AspNetUsers", Function(t) t.UserId) _
                .Index(Function(t) t.UserId) _
                .Index(Function(t) t.SousSecteurActiviteId)
            ...
            CreateTable(
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.Cv", Function(t) t.CvId) _
                .ForeignKey("dbo.TypeCursus", Function(t) t.TypeCursusId) _
                .Index(Function(t) t.TypeCursusId) _
                .Index(Function(t) t.CvId)
            ...
            CreateTable(
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.TypeMessagerie", Function(t) t.TypeMessagerieId) _
                ...
                .Index(Function(t) t.UserExpediteurId) _
                .Index(Function(t) t.UserDestinataireId)
            ...
            CreateTable(
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.Messagerie", Function(t) t.MessagerieId) _
            ...
            CreateTable(
                ...
                .PrimaryKey(Function(t) t.Id) _
                .ForeignKey("dbo.Jobs", Function(t) t.JobsId) _
                .ForeignKey("dbo.AspNetUsers", Function(t) t.UserEmployeurId) _
                .ForeignKey("dbo.AspNetUsers", Function(t) t.UserPrestataireId) _
                .Index(Function(t) t.UserEmployeurId) _
                .Index(Function(t) t.UserPrestataireId) _
                .Index(Function(t) t.JobsId)
        ...
        Public Overrides Sub Down()
            DropForeignKey("dbo.UserSousSecteurActivites", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.UserSousSecteurActivites", "SousSecteurActiviteId", "dbo.SousSecteurActivite")
            DropForeignKey("dbo.Reference", "CvId", "dbo.Cv")
            DropForeignKey("dbo.PostulerJobs", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.PostulerJobs", "JobsId", "dbo.Jobs")
            ...
            DropForeignKey("dbo.JobsNotifications", "NotificationId", "dbo.Notification")
            DropForeignKey("dbo.JobsNotifications", "JobsId", "dbo.Jobs")
            ...
            DropForeignKey("dbo.ConsulterCvs", "UserId", "dbo.AspNetUsers")
            DropForeignKey("dbo.ConsulterCvs", "CvId", "dbo.Cv")
            ...
            DropForeignKey("dbo.Jobs", "UserPublierId", "dbo.AspNetUsers")
            DropForeignKey("dbo.Jobs", "UserAttribuerId", "dbo.AspNetUsers")
            ...
            DropIndex("dbo.UserSousSecteurActivites", New String() { "SousSecteurActiviteId" })
            DropIndex("dbo.UserSousSecteurActivites", New String() { "UserId" })
            DropIndex("dbo.Reference", New String() { "CvId" })
            DropIndex("dbo.PostulerJobs", New String() { "JobsId" })
            DropIndex("dbo.PostulerJobs", New String() { "UserId" })
            ...
            DropIndex("dbo.JobsNotifications", New String() { "NotificationId" })
            DropIndex("dbo.JobsNotifications", New String() { "JobsId" })
            DropIndex("dbo.Divers", New String() { "CvId" })
            DropIndex("dbo.Cursus", New String() { "CvId" })
            DropIndex("dbo.Cursus", New String() { "TypeCursusId" })
            DropIndex("dbo.ConsulterCvs", New String() { "UserId" })
            DropIndex("dbo.ConsulterCvs", New String() { "CvId" })
            ...
            DropIndex("dbo.Jobs", New String() { "UserAttribuerId" })
            DropIndex("dbo.Jobs", New String() { "UserPublierId" })
            ...
            DropTable("dbo.UserSousSecteurActivites")
            DropTable("dbo.Reference")
            DropTable("dbo.PostulerJobs")
