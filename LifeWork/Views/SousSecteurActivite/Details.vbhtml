@ModelType SousSecteurActivite
@Imports LifeWork.My.Resources
@Code
    ViewData("Title") = Resource.Details_SousSecteurActivite
End Code

<h2>@Resource.Details_SousSecteurActivite</h2>
...
<div>
    <dl class="dl-horizontal">
        ...
        <dd>
            @Html.DisplayFor(Function(model) model.SecteurActivite.Libelle)
        </dd>
...
<p>
    @Html.ActionLink(Resource.Edit_SousSecteurActivite, "Edit", New With {.id = Model.Id}) |
